    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          MokuaiHeader(
            biaoti,
            caozuoAnniu: headerAnniu,
            neibuPadding: const EdgeInsets.symmetric(
              horizontal: 16,
              vertical: 10,
            ),
          ),
  ...
  Widget _jibenXinxi() {
    return Column(
      children: [
        Row(
          children: [
            Expanded(child: TextFormField(decoration: biaoqianInput('姓名'))),
            jianju12(),
            Expanded(child: TextFormField(decoration: biaoqianInput('年龄'))),
            jianju12(),
            Expanded(
              child: DropdownButtonFormField<String>(
                decoration: biaoqianInput('性别'),
                items: const [
        ...
        Row(
          children: [
            Expanded(child: TextFormField(decoration: biaoqianInput('住址'))),
            jianju12(),
            Expanded(
              child: TextFormField(decoration: biaoqianInput('电话号码（唯一标识）')),
            ),
          ],
        ),
        const SizedBox(height: 12),
        Row(
          children: [
            Expanded(child: TextFormField(decoration: biaoqianInput('过敏史'))),
            jianju12(),
            Expanded(child: TextFormField(decoration: biaoqianInput('既往史'))),
          ],
        ),
        const SizedBox(height: 12),
  ...
  Widget _jiuzhenXinxi() {
    return Column(
      children: [
        Row(
          children: [
            Expanded(child: TextFormField(decoration: biaoqianInput('主诉'))),
            jianju12(),
            Expanded(child: TextFormField(decoration: biaoqianInput('现病史'))),
          ],
        ),
        const SizedBox(height: 12),
        Row(
          children: [
            Expanded(child: TextFormField(decoration: biaoqianInput('临床诊断'))),
            jianju12(),
            Expanded(child: TextFormField(decoration: biaoqianInput('中医诊断'))),
          ],
        ),
        const SizedBox(height: 12),
        TextFormField(decoration: biaoqianInput('备注'), maxLines: 2),
